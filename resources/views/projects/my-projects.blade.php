...
<main class="main-content w-full px-[var(--margin-x)] pb-8">
    ...
    <div>
        <span class="inline-block px-4 py-1.5 rounded-full text-sm font-bold bg-green-100 text-green-700 shadow-soft mt-2">
            نشط
        </span>
    </div>
</div>
        ...
        <div class="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3 lg:gap-6 xl:grid-cols-4">
            ...
            <div class="flex flex-1 flex-col justify-between rounded-lg bg-warning p-4 sm:p-5">
              <div>
                <div class="flex items-start justify-between">
                  <img class="size-12 rounded-lg object-cover object-center" src="images/others/smartphone.jpg" alt="image">
              ...
              <div>
                ...
                <div class="mt-4 flex items-center justify-between space-x-2">
                  ...
                  <div>
                    <button class="btn -mr-1.5 size-8 rounded-full p-0 text-white hover:bg-white/20 focus:bg-white/20 active:bg-white/25">
          ...
          <div class="card shadow-none">
            <div class="flex flex-1 flex-col justify-between rounded-lg bg-secondary/15 p-4 dark:bg-transparent sm:p-5">
              <div>
                <div class="flex items-start justify-between">
                  <img class="size-12 rounded-lg object-cover object-center" src="images/illustrations/chat-ui.svg" alt="image">
          ...
          <div class="card shadow-none">
            <div class="flex flex-1 flex-col justify-between rounded-lg bg-success/15 p-4 dark:bg-transparent sm:p-5">
              <div>
                <div class="flex items-start justify-between">
                  <img class="size-12 rounded-lg object-cover object-center" src="images/illustrations/store-ui.svg" alt="image">
          ...
          <div class="card shadow-none">
            <div class="flex flex-1 flex-col justify-between rounded-lg bg-error/15 p-4 dark:bg-transparent sm:p-5">
              <div>
                <div class="flex items-start justify-between">
                  <img class="size-12 rounded-lg object-cover object-center" src="images/illustrations/nft.svg" alt="image">
          ...
          <div class="card shadow-none">
            <div class="flex flex-1 flex-col justify-between rounded-lg bg-warning/15 p-4 dark:bg-transparent sm:p-5">
              <div>
                <div class="flex items-start justify-between">
                  <img class="size-12 rounded-lg object-cover object-center" src="images/illustrations/lms-ui.svg" alt="image">
                  <p class="text-xs+">Jan 03, 2021</p>
                </div>
                <h3 class="mt-3 font-medium text-slate-700 line-clamp-2 dark:text-navy-100">
                  LMS App Design

            ...
            <div class="card col-span-12 lg:col-span-8">
                <div class="mt-3 flex flex-col justify-between px-4 sm:flex-row sm:items-center sm:px-5">
                    <div class="flex flex-1 items-center justify-between space-x-2 sm:flex-initial">
                        <h2 class="text-sm+ font-medium tracking-wide text-slate-700 dark:text-navy-100">Order Overview</h2>
            ...
            <div class="col-span-12 grid grid-cols-2 gap-4 sm:grid-cols-4 sm:gap-5 lg:col-span-4 lg:grid-cols-2 lg:gap-6">
                <div class="card col-span-2 px-4 pb-5 sm:px-5">
                    <div class="flex items-center justify-between py-3">
                        <h2 class="font-medium tracking-wide text-slate-700 dark:text-navy-100">Budget</h2>
                    ...
                    <div class="flex grow space-x-5">
                        <div class="flex w-1/2 flex-col">
                            ...
                            <p class="mt-2 text-xs leading-normal line-clamp-3">You have spent about 25% of your annual budget.</p>
                        </div>
                ...
                <div class="card">
                    <div class="mt-3 flex items-center justify-between px-4 sm:px-5">
                        <h2 class="font-medium tracking-wide text-slate-700 dark:text-navy-100">Income</h2>
                        <div x-data="usePopper({placement:'bottom-end',offset:4})" @click.outside="isShowPopper && (isShowPopper = false)" class="inline-flex">
                    ...
                    <p class="grow px-4 text-xl font-semibold text-slate-700 dark:text-navy-100 sm:px-5">$169.6k</p>
                ...
                <div class="card">
                <div class="mt-3 flex items-center justify-between px-4 sm:px-5">
                    <h2 class="font-medium tracking-wide text-slate-700 dark:text-navy-100">Expense</h2>
                    <div x-data="usePopper({placement:'bottom-end',offset:4})" @click.outside="isShowPopper && (isShowPopper = false)" class="inline-flex">
                        <button x-ref="popperRef" @click="isShowPopper = !isShowPopper" class="btn -mr-2 size-7 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                            <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none" viewbox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M5 12h.01M12 12h.01M19 12h.01M6 12a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0z"></path>
                ...
                <p class="grow px-4 text-xl font-semibold text-slate-700 dark:text-navy-100 sm:px-5">$34.6k</p>
                <div class="ax-transparent-gridline">
            ...
            <div class="card col-span-12 pb-2 lg:col-span-5 xl:col-span-6">
                ...
                <div class="w-56 shrink-0 rounded-xl bg-slate-50 p-4 dark:bg-navy-600">
                    ...
                    <div class="size-16 rounded-full bg-gradient-to-r from-sky-400 to-blue-600 p-0.5">
                        <img class="h-full w-full rounded-full border-2 border-white object-cover object-center dark:border-navy-700" src="{{ URL::to('assets/images/avatar/avatar-20.jpg') }}" alt="image">
                    </div>
                    <div>
                        <p class="text-base font-medium text-slate-700 dark:text-navy-100">StarCodeKh</p>
                        <p class="text-xs+ text-slate-400 dark:text-navy-300">Salesman</p>
                    </div>
                    </div>
                    <div class="mt-5">
                    <div>
                        ...
                        <div class="mt-0.5 flex space-x-2">
                            ...
                            <p class="flex items-center space-x-0.5 text-xs text-success">
                                <svg xmlns="http://www.w3.org/2000/svg" class="size-4" fill="none" viewbox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 11l5-5m0 0l5 5m-5-5v12"></path></svg>
                                <span>4.3%</span>
                            </p>
                        </div>
                    </div>
                ...
                <div class="w-56 shrink-0 rounded-xl bg-slate-50 p-4 dark:bg-navy-600">
                    <div class="flex flex-col items-center space-y-3 text-center">
                    <div class="size-16 rounded-full bg-gradient-to-r from-sky-400 to-blue-600 p-0.5">
                        <img class="h-full w-full rounded-full border-2 border-white object-cover object-center dark:border-navy-700" src="{{ URL::to('assets/images/avatar/avatar-5.jpg') }}" alt="image">
                    </div>
                    <div>
                ...
                <div class="w-56 shrink-0 rounded-xl bg-slate-50 p-4 dark:bg-navy-600">
                    <div class="flex flex-col items-center space-y-3 text-center">
                    <div class="size-16 rounded-full bg-gradient-to-r from-sky-400 to-blue-600 p-0.5">
                        <img class="h-full w-full rounded-full border-2 border-white object-cover object-center dark:border-navy-700" src="{{ URL::to('assets/images/avatar/avatar-11.jpg') }}" alt="image">
                    </div>
                    <div>
                        <p class="text-base font-medium text-slate-700 dark:text-navy-100">
                        Katrina West
                ...
                <div class="w-56 shrink-0 rounded-xl bg-slate-50 p-4 dark:bg-navy-600">
                    <div class="flex flex-col items-center space-y-3 text-center">
                    <div class="size-16 rounded-full bg-gradient-to-r from-sky-400 to-blue-600 p-0.5">
                        <img class="h-full w-full rounded-full border-2 border-white object-cover object-center dark:border-navy-700" src="{{ URL::to('assets/images/avatar/avatar-17.jpg') }}" alt="image">
                    </div>
                    <div>
                        <p class="text-base font-medium text-slate-700 dark:text-navy-100">
                        Henry Curtis
            ...
            <div class="col-span-12 grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:col-span-7 lg:gap-6 xl:col-span-6">
                ...
                <div class="mt-5 space-y-4">
                    ...
                    <div class="flex items-center space-x-2">
                        <img class="size-6" src="{{ URL::to('assets/images/logos/instagram-round.svg') }}" alt="flag">
                        <p>Instagram</p>
                    </div>
                    <div class="flex items-center space-x-2">
                    ...
                    <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-2">
                        <img class="size-6" src="{{ URL::to('assets/images/logos/facebook-round.svg') }}" alt="flag">
                        <p>Facebook</p>
                    </div>
                    <div class="flex items-center space-x-2">
                        <p class="text-sm+ text-slate-800 dark:text-navy-100">
                    ...
                    <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-2">
                        <img class="size-6" src="{{ URL::to('assets/images/logos/youtube-round.svg') }}" alt="flag">
                        <p>Youtube</p>
                    </div>
                    <div class="flex items-center space-x-2">
                        <p class="text-sm+ text-slate-800 dark:text-navy-100">
                    ...
                    <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-2">
                        <img class="size-6" src="{{ URL::to('assets/images/logos/pinterest-round.svg') }}" alt="flag">
                        <p>Pinterest</p>
                    </div>
                    <div class="flex items-center space-x-2">
                        <p class="text-sm+ text-slate-800 dark:text-navy-100">
                    ...
                    <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-2">
                        <img class="size-6" src="{{ URL::to('assets/images/logos/discord-round.svg') }}" alt="flag">
                        <p>Discord</p>
                    </div>
                    <div class="flex items-center space-x-2">
                        <p class="text-sm+ text-slate-800 dark:text-navy-100">
                    ...
                    <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-2">
                        <img class="size-6" src="{{ URL::to('assets/images/logos/tik_tok-round.svg') }}" alt="flag">
                        <p>TikTok</p>
                    </div>
                    <div class="flex items-center space-x-2">
                        <p class="text-sm+ text-slate-800 dark:text-navy-100">
                    ...
                    <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-2">
                        <img class="size-6" src="{{ URL::to('assets/images/logos/twitter-round.svg') }}" alt="flag">
                        <p>Twitter</p>
                    </div>
                    <div class="flex items-center space-x-2">
                        <p class="text-sm+ text-slate-800 dark:text-navy-100">
                    ...
                    <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-2">
                        <img class="size-6" src="{{ URL::to('assets/images/logos/tumblr-round.svg') }}" alt="flag">
                        <p>Tumblr</p>
                    </div>
                    <div class="flex items-center space-x-2">
                        <p class="text-sm+ text-slate-800 dark:text-navy-100">
                ...
                <div class="mt-5 space-y-4">
                    <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-2">
                        <img class="size-6" src="{{ URL::to('assets/images/flags/australia-round.svg') }}" alt="flag">
                        <p>Australia</p>
                    </div>
                    <div class="flex items-center space-x-2">
                        <p class="text-sm+ text-slate-800 dark:text-navy-100">
                    ...
                    <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-2">
                        <img class="size-6" src="{{ URL::to('assets/images/flags/brazil-round.svg') }}" alt="flag">
                        <p>Brazil</p>
                    </div>
                    <div class="flex items-center space-x-2">
                        <p class="text-sm+ text-slate-800 dark:text-navy-100">
                    ...
                    <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-2">
                        <img class="size-6" src="{{ URL::to('assets/images/flags/china-round.svg') }}" alt="flag">
                        <p>China</p>
                    </div>
                    <div class="flex items-center space-x-2">
                        <p class="text-sm+ text-slate-800 dark:text-navy-100">
                    ...
                    <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-2">
                        <img class="size-6" src="{{ URL::to('assets/images/flags/india-round.svg') }}" alt="flag">
                        <p>India</p>
                    </div>
                    <div class="flex items-center space-x-2">
                        <p class="text-sm+ text-slate-800 dark:text-navy-100">
                    ...
                    <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-2">
                        <img class="size-6" src="{{ URL::to('assets/images/flags/italy-round.svg') }}" alt="flag">
                        <p>Italy</p>
                    </div>
                    <div class="flex items-center space-x-2">
                        <p class="text-sm+ text-slate-800 dark:text-navy-100">
                    ...
                    <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-2">
                        <img class="size-6" src="{{ URL::to('assets/images/flags/japan-round.svg') }}" alt="flag">
                        <p>Japan</p>
                    </div>
                    <div class="flex items-center space-x-2">
                        <p class="text-sm+ text-slate-800 dark:text-navy-100">
                    ...
                    <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-2">
                        <img class="size-6" src="{{ URL::to('assets/images/flags/russia-round.svg') }}" alt="flag">
                        <p>Russia</p>
                    </div>
                    <div class="flex items-center space-x-2">
                        <p class="text-sm+ text-slate-800 dark:text-navy-100">
                    ...
                    <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-2">
                        <img class="size-6" src="{{ URL::to('assets/images/flags/spain-round.svg') }}" alt="flag">
                        <p>Spain</p>
                    </div>
                    <div class="flex items-center space-x-2">
                        <p class="text-sm+ text-slate-800 dark:text-navy-100">
                    ...
                    <tbody>
                        ...
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                            ...
                            <div class="avatar size-9">
                                <img class="mask is-squircle" src="{{ URL::to('assets/images/avatar/avatar-20.jpg') }}" alt="avatar">
                            </div>
                        ...
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                            <div class="flex items-center space-x-4">
                            <div class="avatar size-9">
                                <img class="mask is-squircle" src="{{ URL::to('assets/images/avatar/avatar-19.jpg') }}" alt="avatar">
                            </div>
                        ...
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                            <div class="flex items-center space-x-4">
                            <div class="avatar size-9">
                                <img class="mask is-squircle" src="{{ URL::to('assets/images/avatar/avatar-18.jpg') }}" alt="avatar">
                            </div>
                        ...
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                            <div class="flex items-center space-x-4">
                            <div class="avatar size-9">
                                <img class="mask is-squircle" src="{{ URL::to('assets/images/avatar/avatar-17.jpg') }}" alt="avatar">
                            </div>
                        ...
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                            <div class="flex items-center space-x-4">
                            <div class="avatar size-9">
                                <img class="mask is-squircle" src="{{ URL::to('assets/images/avatar/avatar-16.jpg') }}" alt="avatar">
                            </div>
                        ...
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                            <div class="flex items-center space-x-4">
                            <div class="avatar size-9">
                                <img class="mask is-squircle" src="{{ URL::to('assets/images/avatar/avatar-11.jpg') }}" alt="avatar">
                            </div>
                        ...
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                            <div class="flex items-center space-x-4">
                            <div class="avatar size-9">
                                <img class="mask is-squircle" src="{{ URL::to('assets/images/avatar/avatar-1.jpg') }}" alt="avatar">
                            </div>
                        ...
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                            <div class="flex items-center space-x-4">
                            <div class="avatar size-9">
                                <img class="mask is-squircle" src="{{ URL::to('assets/images/avatar/avatar-2.jpg') }}" alt="avatar">
                            </div>
                        ...
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                            <div class="flex items-center space-x-4">
                            <div class="avatar size-9">
                                <img class="mask is-squircle" src="{{ URL::to('assets/images/avatar/avatar-5.jpg') }}" alt="avatar">
                            </div>
                        ...
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                            <div class="flex items-center space-x-4">
                            <div class="avatar size-9">
                                <img class="mask is-squircle" src="{{ URL::to('assets/images/avatar/avatar-7.jpg') }}" alt="avatar">
                            </div>

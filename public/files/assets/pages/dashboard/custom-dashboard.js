...
$(document).ready(function() {
    var chart1Element = document.getElementById('update-chart-1');
    if (chart1Element) {
    ...
    var chart2Element = document.getElementById('update-chart-2');
    if (chart2Element) {
    ...
    var chart3Element = document.getElementById('update-chart-3');
    if (chart3Element) {
    ...
    var chart4Element = document.getElementById('update-chart-4');
    if (chart4Element) {
    ...
    var appSale1Element = document.getElementById('app-sale1');
    if (appSale1Element) {
        var ctx = appSale1Element.getContext("2d");
        var myChart = new Chart(ctx, {
            type: 'line',
    ...
    var appSale2Element = document.getElementById('app-sale2');
    if (appSale2Element) {
        var ctx = appSale2Element.getContext("2d");
        var myChart = new Chart(ctx, {
            type: 'line',
    ...
    var appSale3Element = document.getElementById('app-sale3');
    if (appSale3Element) {
        var ctx = appSale3Element.getContext("2d");
        var myChart = new Chart(ctx, {
            type: 'line',
    ...
    var appSale4Element = document.getElementById('app-sale4');
    if (appSale4Element) {
        var ctx = appSale4Element.getContext("2d");
        var myChart = new Chart(ctx, {
            type: 'line',
